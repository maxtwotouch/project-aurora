...
Die App funktioniert vollständig ohne Konto, Login oder Einrichtung. Der Standort ist optional — er wird auf Ihrem Telefon für den Trip-Modus genutzt und, nur wenn Sie zustimmen, um anonyme Tourismus-Einblicke auf Gebietsebene beizusteuern; Ihr genauer Standort wird nie gesendet. Wenn Sie möchten, können Sie freiwillig anonyme, aggregierte Zählungen teilen (welche Orte angesehen oder navigiert werden, nach Stunde gebündelt), damit wir und die Tromsø kommune sehen, welche Orte tatsächlich genutzt werden. Eine Ablehnung ändert nichts an der Funktion der App, und Sie können das Teilen jederzeit in den Einstellungen ein- oder ausschalten. Diese App enthält keine Tracker oder Werbe-SDKs von Drittanbietern.
